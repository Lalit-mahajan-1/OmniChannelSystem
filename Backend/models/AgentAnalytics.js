...
const AgentAnalyticsSchema = new mongoose.Schema(
  {
    ...
    channel: { type: String, enum: ['email', 'whatsapp'], index: true },
    inboundMessage: { type: String, default: '' },
    aiReply: { type: String, default: '' },
    model: { type: String, default: 'llama-3.3-70b-versatile' },
    generationLatencyMs: { type: Number, default: 0 },
    sendLatencyMs: { type: Number, default: 0 },
    totalLatencyMs: { type: Number, default: 0 },
    messageLength: { type: Number, default: 0 },
    replyLength: { type: Number, default: 0 },
    autoReplyEnabled: { type: Boolean, default: null },
    errorMessage: { type: String, default: '' },
    metadata: { type: Object, default: {} },
  },
  { timestamps: true, collection: 'agentanalytics' }
);

module.exports = mongoose.models.AgentAnalytics || mongoose.model('AgentAnalytics', AgentAnalyticsSchema);
